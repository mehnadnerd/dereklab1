...
int main(int argc, char *argv[]) {
    ...
    else if ((matrix_dimension_size >= 32) && (matrix_dimension_size%32 == 0)) {
        xdim = 32;
        ydim = 32;
    }
    else if ((matrix_dimension_size >= 16) && (matrix_dimension_size%16 == 0)) {
        xdim = 16;
        ydim = 16;
    }
    else if ((matrix_dimension_size >= 8) && (matrix_dimension_size%8 == 0)) {
        xdim = 8;
        ydim = 8;
    }
    else if ((matrix_dimension_size >= 2) && (matrix_dimension_size%2 == 0)) {
        xdim = 2; // number from ass
        ydim = 2;
    }
    else {
        xdim = 1;
